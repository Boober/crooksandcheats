...
//include the model
var model = require("../models/abilities.js");
...
doCreate = function(req,res)
{
	...
	//Restrict the parameters to the ones we expect. 9Don't allow user to add properties outside of what we expect.
		...
		(!req.body.name || !req.body.targets || !req.body.description || !req.body.effect))
	{
		res.render('message', {title: 'monsters', obj: "Invalid parameters. (Need name, description, targets, effect.)"});
		return;
	}
