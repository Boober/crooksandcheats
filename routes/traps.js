...
doCreate = function(req,res)
{
	...
	//Restrict the parameters to the ones we expect. 9Don't allow user to add properties outside of what we expect.
		...
		(!req.body.name || !req.body.penalty  || !req.body.description || !req.body.reward))
	{
		res.render('message', {title: 'monsters', obj: "Invalid parameters. (Need name, description, penalty, and reward.)"});
		return;
	}
